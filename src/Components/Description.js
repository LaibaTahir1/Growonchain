        ...
        <div className='text-center '>
          <div className='flex gap-20 justify-center p-10'>
            <div className='block'>
              ...
              <h1 className='font-semibold  text-start text-6xl  text-[#9364EB]'>About the </h1>
              <h1 className=' text-start text-[54px] font-semibold  text-[#9364EB]'>Course</h1>
              </div>
          ...
          <div className='flex gap-20  justify-center mb-20 mt-20'>
            <div className='block leading-[51px]'>
              <h1 className=' font-semiabold text-[54px]  text-green-300'>Is It For </h1>
              <h1 className='font-semibold  text-start text-[54px]  text-green-300'>You?</h1>
            </div>
            <p className='w-96 text-start leading-[22px]'>This Web3 Cohort is an invite-only 8 weeks of focused, collaborative learning complete with curated instructional courses, expert guest lectures, demos, and engagement activities to ensure participants walk away with a deep understanding of the Web3 and crypto ecosystem. We will meet twice weekly to learn and demo various protocols, use cases, platforms, and projects. </p>
          </div>
        </div>
