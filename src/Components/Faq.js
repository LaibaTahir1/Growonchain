    ...
    <div className=' text-white'>
      <div className='max-w-[800px] mx-auto w-full '>
        ...
        <div className='mt-[60px] text-start  '>
          ...
          <h1 className=' text-[#2C3B87] pt-3  text-start   font-semibold text-lg md:text-2xl'>  What is the time Commitment?</h1>
          </div>
         <div className='flex pb-3 pl-3 pr-3  gap-2.5  mt-4  bg-[#93A4F3] max-w-[800px] w-full mx-auto rounded-xl '>
         <img className='pt-3'  src="./assets/images/arrow.png" alt='' />
         <h1 className=' text-[#2C3B87] pt-3  text-start   font-semibold text-lg md:text-2xl'> Who is web three cohort for?
          ...
          <img className='pt-3'  src="./assets/images/arrow.png" alt='' />
          <h1 className=' text-[#2C3B87] pt-3  text-start   font-semibold text-lg md:text-2xl'>What will i learn in this chorot?</h1>
          </div>
          <div className=' rounded-t-lg   mt-4 '>
            ...
            <h1 className=' text-[#2C3B87] pt-3  text-start   font-semibold text-[15px] md:text-[24px]'>What is the Web3 Cohort?</h1>
            </div>
            <h1 className='block justify-center pt-3 pl-8 pr-8 pb-6 text-white bg-[#2C3B87]  max-w-[800px] w-full mx-auto text-sm md:text-lg  font-medium'>Our invites-only cohort empower people to unlock financial fredom through crypto  education ,experimantation, and community. Through cohort base learning member will explore and gain learning experience using the top blockchain protocols and applications.</h1>
            <div className='block rounded-b-lg justify-center  text-white bg-blue-900      font-bold text-lg  '>
              <ul className='block justify-center  pl-14 pr-12  text-white bg-[#2C3B87] list-disc  max-w-[800px] w-full mx-auto text-sm md:text-lg  font-medium'><li> 40 ¬ hours of content via a comprehensive learning program:</li>  </ul>
