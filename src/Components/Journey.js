  ...
  return (
    ...
    <div  className=  'bg-[#4A2988] pt-10  pl-10 pr-10 pb-10 max-w-[800px] mx-auto w-full   rounded-xl'>
              ...
              <div className='   w-[350px] mx-auto h-52  bg-[#7943DF] rounded-xl'> 
                ...
                <p className='font-semibold text-lg md:text-2xl  pr-3 mt-4'>Week 2</p>
                </div>
               <div className='text-start  pl-4 font-semibold text-lg md:text-2xl leading-[22px]'> <p className='text-start mt-4' > Blockchain</p>
                <p >  Scaling</p></div>
              </div>
              <div className=' w-[350px] mx-auto h-52  bg-[#7943DF] rounded-xl'>
                <div className=' flex justify-between'>
                <img className='pl-3 pr-3' src="./assets/images/Group.png" alt=''></img>
                <p className='font-semibold text-lg md:text-2xl  pr-3 mt-4'>Week 3</p>
                </div>
                <div className='text-start pl-4 font-semibold text-lg md:text-2xl leading-[22px]'><p className='text-start mt-4' > Decentralized</p>
                <p  >Finance</p></div>
              </div>
              </div>
              {/* 2 */}
              ...
              <div className='  w-[350px] mx-auto h-52  bg-[#7943DF] rounded-xl'>
                <div className=' flex justify-between'>
                <img className='pl-3 pt-3' src="./assets/images/Group.png" alt=''></img>
                <p className='font-semibold text-lg md:text-2xl  pr-3 mt-4'>Week 4</p>
                </div>
               <div className='text-start pl-4 font-semibold text-lg md:text-2xl leading-[22px]'> <p className='text-start mt-4' > Non-Fungible</p>
                <p  >Tokens</p></div>
              </div>
              <div className='  w-[350px] mx-auto h-52 bg-[#7943DF] rounded-xl'>
                <div className=' flex justify-between'>
                <img className='pl-3 pt-3' src="./assets/images/Group.png" alt=''></img>
                <p className='font-semibold text-lg md:text-2xl  pr-3 mt-4'>Week 5</p>
                </div>
                <div className='text-start pl-4 font-semibold text-lg md:text-2xl leading-[22px]'><p className='text-start mt-4' >Gaming &</p>
                <p  > MetaVerse</p></div>
              </div>
              </div>
              {/* 3 */}
              ...
              <div className='   w-[350px] mx-auto h-52 bg-[#7943DF] rounded-xl'>
                <div className=' flex justify-between'>
                <img className='pl-3 pt-3' src="./assets/images/Group.png" alt=''></img>
                <p className='font-semibold text-lg md:text-2xl  pr-3 mt-4'>Week 6</p>
                </div>
                <div className='text-start pl-4 font-semibold text-lg md:text-2xl leading-[22px]' ><p className='text-start mt-4 ' > DAO </p>
                <p >  Governance & Grants</p></div>
              </div>
              <div className='  w-[350px] mx-auto h-52  bg-[#7943DF] rounded-xl'>
                <div className=' flex  justify-between'>
                <img className='pl-3 pt-3'src="./assets/images/Group.png" alt=''></img>
                <p className='font-semibold text-lg md:text-2xl  pr-3 mt-4'>Week 7</p>
                </div>
               <div className='text-start pl-4 font-semibold text-lg md:text-2xl leading-[22px]'> <p className='mt-4 text-semibold text-lg md:text-2xl ' > Web3 Social </p>
