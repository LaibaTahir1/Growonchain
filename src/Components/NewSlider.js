...
function NewSlider() {
  return (
    ...
    <img className='rounded-t-[20px] '  src='assets/images/New1.png ' alt='' />
    <div className= ' mt-3.5 pr-3 pl-5'><img src='assets/images/border.png' alt='' /></div>
    <h2 className='text-2xl pl-5 font-semibold mt-4 leading-8'>What is $AXS & </h2>
    <h2 className='text-2xl pl-5 font-semibold leading-8'> $SLP Token?</h2>
    ...
    <img className=' ' src='assets/images/XP.png' alt='' />
      <p className='text-xl font-bold leading-8 '>200</p>
