...
function Returning() {
  return ( 
    <div className='max-w-[1000px] mt-24 mx-auto w-full text-white'>
      ...
      <img className='rounded-t-2xl max-w-[220px]'  src='assets/images/tree.png ' alt='' />
      ...
      <div className='bg-[#131413]  rounded-b-2xl'>
      <img className='rounded-t-2xl w-[220px]' src='assets/images/sky.png ' alt='' />
      <div className= ' mt-2 w-[220px]'><img src='assets/images/border.png' alt='' /></div>
     ...
     <div className='bg-[#131413]  rounded-b-2xl' >
     <img  className='rounded-t-2xl w-[220px]' src='assets/images/Man.png ' alt='' />
      <div className= ' mt-2 w-[220px] '><img src='assets/images/border.png' alt='' /></div>
     ...
     <div className='bg-[#131413]  rounded-b-2xl'>
      <img className='rounded-t-2xl w-[220px] ' src='assets/images/Bulb.png'  alt='' />
      <div className= ' mt-2 w-[220px]'><img src='assets/images/border.png' alt='' /></div>
